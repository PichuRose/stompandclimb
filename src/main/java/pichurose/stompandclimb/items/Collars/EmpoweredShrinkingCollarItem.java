...
public class EmpoweredShrinkingCollarItem extends Item{
    public EmpoweredShrinkingCollarItem(Item.Properties settings) {
        super(settings);
    }
    ...
    public @NotNull InteractionResult interactLivingEntity(ItemStack stack, Player user, LivingEntity entity, InteractionHand hand) {
        ...
        ResizingUtils.resizeInstant(entity, 0.84089641525371454303112547623321f);
        user.getCooldowns().addCooldown(this, 20);
        FriendlyByteBuf buf = PacketByteBufs.create();
        buf.writeInt(entity.getId());
        buf.writeFloat(0.84089641525371454303112547623321f);
