...
public class EmpoweredShrinkingRingItem extends Item{
    public EmpoweredShrinkingRingItem(Item.Properties settings) {
        super(settings);
    }
    ...
    public @NotNull InteractionResultHolder<ItemStack> use(Level world, Player user, InteractionHand hand) {
        ...
        ResizingUtils.resizeInstant(user, 0.84089641525371454303112547623321f);
