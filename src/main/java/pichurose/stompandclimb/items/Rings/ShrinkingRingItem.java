...
public class ShrinkingRingItem extends Item {
    public ShrinkingRingItem(Properties settings) {
        super(settings);
    }
    ...
    public @NotNull InteractionResultHolder<ItemStack> use(Level world, Player user, InteractionHand hand) {
        ...
        ResizingUtils.resizeInstant(user, 0.95760328069857364693630563514792f);
