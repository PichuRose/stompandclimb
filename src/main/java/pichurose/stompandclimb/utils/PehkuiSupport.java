...
public class PehkuiSupport {
    ...
    public static void setup() {
        ...
        ScaleRegistries.SCALE_MODIFIERS.put(new Identifier(StompAndClimb.MODID+":resize"), modifier);
        SACScaleModifier.set(modifier);
        ScaleType suType = ScaleType.Builder.create()
                .affectsDimensions()
                .addDependentModifier(SACScaleModifier.get())
                .build();
        ScaleRegistries.SCALE_TYPES.put(new Identifier(StompAndClimb.MODID+":resize"), suType);
